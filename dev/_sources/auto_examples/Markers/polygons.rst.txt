...
.. "auto_examples\Markers\polygons.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_Markers_polygons.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_Markers_polygons.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/Markers/images/sphx_glr_polygons_001.png
         :alt: polygons
         :srcset: /auto_examples/Markers/images/sphx_glr_polygons_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Markers/images/sphx_glr_polygons_002.png
         :alt:  Signal
         :srcset: /auto_examples/Markers/images/sphx_glr_polygons_002.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/Markers/images/sphx_glr_polygons_003.png
         :alt: polygons
         :srcset: /auto_examples/Markers/images/sphx_glr_polygons_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Markers/images/sphx_glr_polygons_004.png
         :alt:  Signal
         :srcset: /auto_examples/Markers/images/sphx_glr_polygons_004.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_examples_Markers_polygons.py:
